...
[![build](https://img.shields.io/github/checks-status/jeffreylanters/awesome-unity-packages/awesome?label=build&style=for-the-badge)](https://github.com/jeffreylanters/awesome-unity-packages/actions)
...
Hi! My name is Jeffrey Lanters! I've been a Unity developer since 2012 and started open sourcing my project via modules on GitHub in 2020. This inspired my to create an awesome list of other awesome open source Unity packages from all over GitHub.
